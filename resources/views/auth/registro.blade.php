...
@section('content')
    <section class="sign-in-page"
        ...
        <div class="container">
            <div>
                <button class="btn btn-primary-subtle rounded-pill mb-1 mt-3">
                    ...
                    <div class="sign-user_card">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input placeholder="Ingrese carnet" autocomplete="off" required
                                                    type="text" id="Carnet" name="Carnet" class="mb-0 form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">{{ __('authentication.e_mail') }}</label>
                                                <input placeholder="{{ __('authentication.enter_email') }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input placeholder="{{ __('authentication.first_name') }}"
                                                    autocomplete="off" required type="text" id="first_name"
                                                    name="first_name" class="mb-0 form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">{{ __('authentication.last_name') }}</label>
                                                <input placeholder="{{ __('authentication.last_name') }}" autocomplete="off"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input autocomplete="off" required type="date" id="fechaNacimiento"
                                                    name="fechaNacimiento" class="mb-0 form-control">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="mt-3">
                            <div class="d-flex justify-content-center links">
                                {{ __('authentication.already_have_an_account') }}
                                <a class="text-primary ms-2"
                                    href="{{ route('login') }}">{{ __('authentication.sign_in') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
