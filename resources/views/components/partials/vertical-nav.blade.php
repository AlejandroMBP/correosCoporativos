...
<ul class="navbar-nav iq-main-menu" id="sidebar-menu">
    ...
    <li class="nav-item">
        <a class="nav-link {{ Route::is('dashboard.usuario') ? 'active' : '' }}"
            href="{{ route('dashboard.usuario') }}">
            {{-- <a href="{{ route('dashboard.muestra.index') }}"> --}}
            ...
            <span class="item-name">Datos Usuario</span>
        </a>
    </li>
    @can('view_users')
        <li class="nav-item">
            <a class="nav-link {{ Route::is('dashboard.muestra.index') ? 'active' : '' }}"
                href="{{ route('dashboard.muestra.index') }}">
                {{-- <a href="{{ route('dashboard.muestra.index') }}"> --}}
                <i class="icon" data-bs-toggle="tooltip" title="Blank Page" data-bs-placement="right"
                    aria-label="Blank Page">
                    <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="currentColor"
    ...
    <li class="nav-item mb-4">
        <form method="POST" action="{{ route('logout') }}" style="display: inline;">
            ...
            <button type="submit" class="nav-link border-0 bg-transparent">
                <i class="icon fa-solid fa-sign-out-alt" data-bs-toggle="tooltip" data-bs-placement="right"
                    aria-label="Log Out" data-bs-original-title="Log Out"></i>
                <span class="item-name">{{ __('header.logout') }}</span>
            </button>
        </form>
    </li>
