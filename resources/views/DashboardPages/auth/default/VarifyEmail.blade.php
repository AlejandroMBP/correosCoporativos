                        ...
                        <div class="sign-in-page-data">
                            <div class="sign-in-from w-100 m-auto"><img
                                ...
                                <p class="text-white">A email has been send to <a role="button" tabindex="0"
                                    ...
                                    Please
                                    check for an email from company and click on the included link to reset your password.
                                </p>

                                <div class="d-inline-block w-100"><a class="btn btn-primary mt-3"
                                        href="{{ route('dashboard') }}">{{ __('authentication.back_to_home') }}</a></div>
                            </div>
                        </div>
                    </div>
                </div>
