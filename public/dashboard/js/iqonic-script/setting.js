...
(function (window) {
        ...
        if (
            ...
            switch (this.options.saveLocal) {
                ...
                case "sessionStorage":
                    ...
                    return IQUtils.saveSessionStorage(
                        key,
    ...
    IQSetting.prototype.__checkboxUpdate__ = function (
        key,
        value,
        currentValue,
        cb
        ...
        if (typeof value !== typeof null) {
            this.__attributeUpdate__(
                ...
                function (key, val) {
                    document
                        .querySelector("html")
                        .setAttribute("data-bs-theme", value);
                    if (value == "auto") {
                        if (
