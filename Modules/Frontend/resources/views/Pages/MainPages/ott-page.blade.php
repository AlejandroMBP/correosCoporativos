...
@section('content')
                                        ...
                                        <div class="block-images position-relative ">
                                            <div class="img-box">
                                                ...
                                                <div class="block-description">
                                                    <h6 class="iq-title fw-500 mb-0">{{ __('otthome.the_mandalorian') }}
                                                    </h6>
                                        ...
                                        <div class="block-images position-relative ">
                                            <div class="img-box">
                                                <img src="{{ asset('frontend/images/movies/ott3.webp') }}" class="img-fluid"
                                                    alt="" loading="lazy">
                                                <div class="block-description">
                                                    <h6 class="iq-title fw-500 mb-0">{{ __('otthome.better_call_saul') }}
                                                    </h6>
                ...
                <div class="slider-images" data-swiper="slider-images-ott">
                    <div class="swiper-container" data-swiper="slider-images-inner-ott">
                        <div class="swiper-wrapper m-0">
                                    ...
                                    <div class="row align-items-center h-100">
                                        <div class="col-lg-6 col-md-12">
                                            <div class="slider-content">
                                                ...
                                                <p class="line-count-3 RightAnimate-two"> {{ __('otthome.after_death') }}
                                                </p>
                            ...
                            <div class="swiper-slide p-0">
                                <div class="slider--image block-images">
                                    <img src="{{ asset('frontend/images/movies/ott2.webp') }}" loading="lazy"
                                        alt="" />
                                </div>
                                <div class="description">
                                    <div class="row align-items-center h-100">
                            ...
                            <div class="swiper-slide p-0">
                                <div class="slider--image block-images">
                                    <img src="{{ asset('frontend/images/movies/ott3.webp') }}" loading="lazy"
                                        alt="" />
                                </div>
                                <div class="description">
                                    <div class="row align-items-center h-100">
    ...
    @include('frontend::components.sections.recommended', [
        'recommended' => __('otthome.recommended_for_you'),
    ])
